...
- Отрисовка, анимации, звук и экран выбора уровня с выбором числа игроков, максимального количества активных врагов и подсказками
...
На экране выбора уровня доступны три пункта меню:
- **STAGE XX** — выбор уровня (1-35)
- **PLAYERS X** — количество игроков (1 или 2)
- **MAX ENEMIES X** — максимальное количество активных врагов одновременно (3-10)

Активный пункт подсвечивается белым. Дополнительно выводится подсказка `PRESS ENTER TO START` с тем же размером шрифта, что и прочие субтитры.
...
- Запрещено создавать методы-сеттеры (`Set*`) для установки зависимостей от других use cases или сервисов в use cases
